...
All possible values is obtained by TRUE and corresponds to filter "all": "*" in the api query. Elimination of a variables is obtained by FALSE. An imaginary value corresponds to "top" in the api query.
